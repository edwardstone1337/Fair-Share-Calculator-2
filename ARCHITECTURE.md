...
| `components/calculator/calculator-client.tsx` | Orchestrates sections, step (input vs results), URL hash/params, share, snackbar, analytics events; scheduleScrollToError wraps scrollToFirstError and clears timeout on unmount |
